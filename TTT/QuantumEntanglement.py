...
mirror_angle = math.atan2(-to_target.x, to_target.y)

# 添加镜子
mirrors.append([mirror_center.x, mirror_center.y, mirror_angle, True])
...
while running:
    ...
    for mirror in mirrors:
        ...
        # 镜子主体
        color = (120, 180, 255) if len(mirror) >= 4 and mirror[3] else (240, 240, 240)
